...
var ActionsObservable = function (_Observable) {
  ...
  _createClass(ActionsObservable, null, [{
    key: "of",
    value: function of() {
      return new this(_rxjs.of.apply(void 0, arguments));
    }
  }, {
    key: "from",
  ...
  function ActionsObservable(input$) {
    var _this;

    _classCallCheck(this, ActionsObservable);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(ActionsObservable).call(this));
    _this.source = input$;
    return _this;
  }
  ...
  _createClass(ActionsObservable, [{
    ...
    value: function ofType() {
      return _operators.ofType.apply(void 0, arguments)(this);
    }
  }]);
...
exports["default"] = ActionsObservable;